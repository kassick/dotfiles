...
;;   (message "Default font weight: %S" default-height variable-pitch-height)
...
;;   (message "Display width %S" (if (display-graphic-p)
;;                                   (display-pixel-width)
;;                                 "NO GRAPHIC DISPLAY YET"))
...
;; (add-hook 'after-make-frame-hook 'kzk/adjust-font-size)
